...
from .views import UploadFileView, ChartView, DeleteFaceView, FacebookDownloadView, ChattyPrivacyPolicy
...
urlpatterns = [
    ...
    path("privacy", ChattyPrivacyPolicy.as_view(), name="privacy")
]
