        ...
        for message in self.fb_chat.get("messages", ""):
            if message.get("reactions", ""):
                for reaction in message.get("reactions", ""):
                    if (
                        self.correct_string_decoding(reaction.get("actor", ""))
                        == self.name
                    ):
                        reactions.append(
                            self.correct_string_decoding(reaction.get("reaction", ""))
                        )
            ...
            if (
                ...
                if message.get("reactions"):
                    ...
                    for reaction in reaction_list:
                        reaction = self.correct_string_decoding(
                    ...
                    if len(word) > 3:
                        try:
                            participant_words.append(
                                self.correct_string_decoding(word).lower()
                            )
