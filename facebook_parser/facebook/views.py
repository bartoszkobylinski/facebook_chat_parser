...
from facebook.models import (FourCharWord, FiveCharWord, SixCharWord, SevenCharWord, EightCharWord, NineCharWord,
                             TenAndMoreCharWord)
...
class ChartView(TemplateView):
    ...
    def get_context_data(self, *args, **kwargs):
        ...
        context.update(reaction_list=sorted(zip(
            users_list, reaction_list, numbers_react_list), key=lambda x: x[2], reverse=True))
