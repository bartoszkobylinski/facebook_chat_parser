...
fb_file_list = ['nie_ten_watek_1.json','nie_ten_watek_2.json','nie_ten_watek_3.json','nie_ten_watek_4.json','nie_ten_watek_5.json']
...
class FacebookChat:
    ...
    def __str__(self):
        return f'''Facebook chat from file {self._file} has {self._total_chat_messages_number} messages, {self._total_chat_characters_number} characters, 
     {self._total_chat_photos_number} photos, {self._total_chat_gifs_number} gifs.'''
    ...
    def file(self, file):
        ...
        self._total_chat_characters_number += self.get_chat_total_characters_number()
        self._total_chat_photos_number += self.get_chat_total_photos_number()
        self._chat_messages = None
    '''
    @property
    def total_chat_messages_number(self):
        return self._total_chat_messages_number

    @property
    def total_chat_photos_number(self):
        return self._total_chat_photos_number

    @property
    def total_chat_gifs_number(self):
        return self.__total_chat_gifs_number

    @property
    def total_chat_characters_number(self):
        return self.total_chat_characters_number
    '''
    ...
    def get_chat_total_characters_number(self):
        ...
        for message in self.messages:
            total_characters_number += len(message.get('content', ''))
    ...
    def find_chat_word_frequency(self, word: str):
        ...
        word = word.lower()
        for message in self.messages:
            messages_string = messages_string + message.get('content', ' ').lower() + ' '
    ...
    def determine_chat_word_frequency_by_word_length(self, word_len: int):
        messages = []
        for message in self.messages:
            message = message.get('content', ' ').lower()
        ...
        return frequency_counter.most_common(10)
...
freq_of_word  = b.find_chat_word_frequency('chuj')
freq = b.determine_chat_word_frequency_by_word_length(4)
